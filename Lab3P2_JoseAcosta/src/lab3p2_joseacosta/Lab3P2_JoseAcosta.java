            ...
            switch (opcion) {
                ...
                case 6:
                    if (pokemon.isEmpty()) {
                        ...
                        System.out.print("Ingrese el nombre del Pokémon que desea modificar: ");
                        String nombreModificar = entrada.next();

                        Pokemon pokemonModificar = null;
                        for (Pokemon p : pokemon) {
                            if (p.getNombre().equalsIgnoreCase(nombreModificar) && p.getAtrapado()) {
                                pokemonModificar = p;
                                break;
                            }
                        }
                        ...
                        if (pokemonModificar != null) {
                            System.out.println("¿De que tipo de Especie es su pokemon?");
                            System.out.println("1. Pokemon tipo Fuego");
                            System.out.println("2. Pokemon tipo Agua");
